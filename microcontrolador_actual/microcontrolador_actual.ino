...
const int wsPort = 8765;                // Puerto del servidor Python WebSocket
const char *wsPath = "/";               // Ruta del servidor WebSocket
...
void setup()
{
    ...
    // ESP32 final - solo espera mensajes, no envía automáticamente
    Serial.println("ESP32 FINAL configurado - Esperando mensaje de la cadena...");
}
...
void loop()
{
    ...
    // ESP32 final - solo procesa mensajes recibidos, no envía automáticamente
...
void setupWebServer()
{
    ...
    if (server.hasArg("plain")) {
      ...
      String newMessage = receivedMessage + " y ese es el final de esta historia.";
